#
#  Be sure to run `pod spec lint WFTabbarController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ddky tabbar"

  spec.homepage     = "https://github.com/zhhwww12/WFTabbarController"
  ...
  spec.source_files  = "WFTabbarFramework/WFTabbar/*.{h,m}"
  ...
  spec.resources = "WFTabbarFramework/Resources/*.png"
